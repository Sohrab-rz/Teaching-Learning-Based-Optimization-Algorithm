...
while(flag)
    ...
    for i=1:ps
       ...
       % learner phase finished ----------------------------------------\\ 
        ...
        global_max=-out_new_1(best_solution_position(1,1));
        if n_i==n_g
            flag=0;
        else 
            flag=1;
...
disp("global maximum cost: " +num2str(global_max))
disp("global maximum location: x1= "+num2str(in_new_1(best_solution_position(1,1),1))+", x2= "+num2str(in_new_1(best_solution_position(1,1),2)))
...
colorbar
hold on
plot3(in_new_1(best_solution_position(1,1),1),in_new_1(best_solution_position(1,1),2),global_max,'rX','markersize',20);
